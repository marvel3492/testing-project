...
public class ShoppingCartTests {
    ...
    void invalidAddToCartTests() {
        ...
        assertEquals(0.0, ShoppingCart.getRawTotal());
        ...
        assertEquals(0.01, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ShoppingCart.addToCart(1, 1);
        assertEquals(0.01, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
    ...
    void addToCartTest0() {
        ...
        captureStdOut.compare(new String[] {
                "Cart is empty", "Item with item ID 0 does not exist", "Cart is empty",
                "Item with item ID 1 does not exist", "Cart is empty"
        });
    }
    ...
    void addToCartTest2() {
        ...
        ShoppingCart.printContents();
        ShoppingCart.addToCart(2, 1);
        assertEquals(0.03, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ...
        captureStdOut.compare(
                ...
                Item with item ID 3 does not exist
                ID: 1 | Item: a | Quantity: 1
                ID: 2 | Item: b | Quantity: 1
                """
        );
    ...
    void addToCartTest3() {
        ...
        ShoppingCart.printContents();
        ShoppingCart.addToCart(3, 1);
        assertEquals(0.06, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ...
        captureStdOut.compare(
                ...
                Item with item ID 4 does not exist
                ID: 1 | Item: a | Quantity: 1
                ID: 2 | Item: b | Quantity: 1
                ID: 3 | Item: c | Quantity: 1
                """
    ...
    void addToCartTest4() {
        ...
        ShoppingCart.printContents();
        ShoppingCart.addToCart(4, 1);
        assertEquals(0.10, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ShoppingCart.addToCart(5, 1);
        assertEquals(0.10, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        captureStdOut.compare(
                """
                ...
                Item with item ID 5 does not exist
                ID: 1 | Item: a | Quantity: 1
                ID: 2 | Item: b | Quantity: 1
                ID: 3 | Item: c | Quantity: 1
                ID: 4 | Item: d | Quantity: 1
    ...
    void addToCartQuantityTest() {
        ...
        assertEquals(0.02, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        captureStdOut.compare(new String[] {
                "Cart is empty", "a is added to the shopping cart",
                "The current count of items in the cart: 2", "ID: 1 | Item: a | Quantity: 2"
        });
    }
    ...
    void addToCartOverflowTests() {
        ...
        assertEquals((Integer.MAX_VALUE - 1) * 0.01, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ShoppingCart.addToCart(2, 1);
        assertEquals((Integer.MAX_VALUE - 1) * 0.01 + 0.02, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ShoppingCart.addToCart(3, 1);
        assertEquals((Integer.MAX_VALUE - 1) * 0.01 + 0.02, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
    ...
    void printCurrentTotalTest2() {
        ...
        captureStdOut.compare(new String[] {
                ...
                "The total for the items in the shopping cart: $53.00", "b is added to the shopping cart",
                "The current count of items in the cart: 2",
                "The total for the items in the shopping cart: $53.01"
        });
    }
    ...
    void printCurrentTotalTest3() {
        ...
        ShoppingCart.addToCart(1, 1);
        ShoppingCart.printCurrentTotal(true, false);
        captureStdOut.compare(new String[] {
                "a is added to the shopping cart", "The current count of items in the cart: 1",
                "The total for the items in the shopping cart: $131.00"
        });
    }
    ...
    void printCurrentTotalTest4() {
        ...
        captureStdOut.compare(new String[] {
                "a is added to the shopping cart", "The current count of items in the cart: 1",
                "The total for the items in the shopping cart: $59.98", "b is added to the shopping cart",
                "The current count of items in the cart: 2",
                "The total for the items in the shopping cart: $59.99"
        });
    }

    @Test
    void printCurrentTotalTest5() {
        assertDoesNotThrow(()->Items.addItem("a", 50.0));
        assertDoesNotThrow(()->Items.addItem("b", 0.01));
        ShoppingCart.addToCart(1, 1);
        ShoppingCart.printCurrentTotal(false, true);
    ...
    void editQuantityTest0() {
        ...
        ShoppingCart.printContents();
        captureStdOut.compare(new String[] {
                "Cart is empty", "Shopping cart does not have item with item ID 0", "Cart is empty",
                "Shopping cart does not have item with item ID 1", "Cart is empty"
        });
    }

    @Test
    void editQuantityTest1() {
        assertDoesNotThrow(()->Items.addItem("a", 0.01));
        assertEquals(0.0, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ShoppingCart.addToCart(1, 1);
    ...
    void editQuantityTest2() {
        ...
        ShoppingCart.printContents();
        ShoppingCart.editQuantity(1, 2);
        assertEquals(0.04, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ShoppingCart.editQuantity(1, 2);
        assertEquals(0.04, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ...
        assertEquals(0.05, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ShoppingCart.editQuantity(2, 2);
        assertEquals(0.05, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
    ...
    void editQuantityTest3() {
        ...
        ShoppingCart.printContents();
        ShoppingCart.editQuantity(1, 2);
        assertEquals(0.07, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ShoppingCart.editQuantity(1, 2);
        assertEquals(0.07, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ...
        ShoppingCart.printContents();
        ShoppingCart.editQuantity(2, 2);
        assertEquals(0.08, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ShoppingCart.editQuantity(2, 2);
        assertEquals(0.08, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ...
        assertEquals(0.09, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ShoppingCart.editQuantity(3, 2);
        assertEquals(0.09, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
    ...
    void editQuantityTest4() {
        ...
        ShoppingCart.printContents();
        ShoppingCart.editQuantity(1, 2);
        assertEquals(0.11, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ShoppingCart.editQuantity(1, 2);
        assertEquals(0.11, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ...
        ShoppingCart.printContents();
        ShoppingCart.editQuantity(2, 2);
        assertEquals(0.12, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ShoppingCart.editQuantity(2, 2);
        assertEquals(0.12, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ...
        ShoppingCart.printContents();
        ShoppingCart.editQuantity(3, 2);
        assertEquals(0.13, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ShoppingCart.editQuantity(3, 2);
        assertEquals(0.13, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ...
        assertEquals(0.14, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
        ShoppingCart.editQuantity(4, 2);
        assertEquals(0.14, ShoppingCart.getRawTotal());
        ShoppingCart.printContents();
    ...
    void checkoutTests() {
        ...
        ShoppingCart.addToCart(1, 1);
        assertFalse(ShoppingCart.checkout());
        ShoppingCart.addToCart(2, 1);
        assertFalse(ShoppingCart.checkout());
        ShoppingCart.editQuantity(2, 2);
